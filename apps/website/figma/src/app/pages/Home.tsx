    ...
    <div className="bg-zinc-950 min-h-screen text-zinc-300 font-sans selection:bg-zinc-800 selection:text-white pb-32">
      <section className="relative px-4 pt-32 pb-24 sm:pt-48 sm:pb-32 lg:px-8 mx-auto max-w-4xl border-b border-zinc-900/50">
        ...
        <h1 className="text-4xl font-medium tracking-tight text-zinc-50 sm:text-5xl md:text-6xl mb-6 leading-[1.1]">
          ResQBrain strukturiert medizinische Inhalte fuer Rettungsdienstorganisationen.
        </h1>

        <p className="text-lg sm:text-xl text-zinc-400 mb-10 max-w-2xl leading-relaxed">
          Ein Offline-First Referenzsystem. Algorithmen, Medikamente und SOPs versioniert abrufen -
          im freigegebenen Stand der eigenen Organisation.
        </p>
      ...
      <section className="px-4 py-24 sm:py-32 lg:px-8 mx-auto max-w-4xl border-b border-zinc-900/50">
        <h2 className="text-2xl font-medium tracking-tight text-zinc-100 mb-12">
        ...
        <div className="space-y-6 mb-12">
          <div className="p-6 rounded border border-zinc-800/60 bg-zinc-900/20">
            <p className="text-lg text-zinc-300 font-medium">
              "PDF-Protokoll, Seite 23 - mobil nicht aufzufinden."
            </p>
          </div>
          <div className="p-6 rounded border border-zinc-800/60 bg-zinc-900/20">
            <p className="text-lg text-zinc-300 font-medium">
              "Neue SOP freigegeben. Team B weiss es noch nicht."
            </p>
          </div>
          <div className="p-6 rounded border border-zinc-800/60 bg-zinc-900/20">
            <p className="text-lg text-zinc-300 font-medium">
              "Nachbereitung passiert, wenn jemand Zeit hat."
            </p>
          </div>
        </div>

        <p className="text-zinc-500 text-sm leading-relaxed max-w-2xl">
          Medizinische Vorgaben entwickeln sich schneller als die Werkzeuge, mit denen sie mobil
          bereitgestellt werden. Das fuehrt zu Unsicherheit und Reibungsverlusten.
        </p>
      </section>

      <section className="px-4 py-24 sm:py-32 lg:px-8 mx-auto max-w-4xl border-b border-zinc-900/50">
        <h2 className="text-2xl font-medium tracking-tight text-zinc-100 mb-12">
          Was ResQBrain bereitstellt
        </h2>
        ...
        <div className="grid gap-6 mb-12">
          <div className="flex gap-4 p-6 rounded border border-zinc-800/60 bg-zinc-900/20">
            ...
            <div>
              ...
              <p className="text-sm text-zinc-400">
                Inhalte direkt auf dem Geraet, kein Netz fuer den Zugriff erforderlich.
              </p>
            </div>
          </div>
          ...
          <div className="flex gap-4 p-6 rounded border border-zinc-800/60 bg-zinc-900/20">
            ...
            <div>
              ...
              <p className="text-sm text-zinc-400">
                Jedes Teammitglied sieht den freigegebenen Stand der eigenen Organisation.
              </p>
            </div>
          </div>
          ...
          <div className="flex gap-4 p-6 rounded border border-zinc-800/60 bg-zinc-900/20">
            ...
            <div>
              ...
              <p className="text-sm text-zinc-400">
                Inhalte und Anpassungen gehoeren der eigenen Organisation, nicht der App.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="p-4 rounded border border-orange-900/30 bg-orange-950/10 flex gap-3 items-start">
          ...
          <p className="text-sm text-orange-200/70 leading-relaxed">
            <strong className="text-orange-200/90 font-medium">Systemgrenze:</strong> ResQBrain
            trifft keine medizinischen Entscheidungen und verarbeitet keine Patientendaten. Es
            strukturiert ausschliesslich statische, offiziell freigegebene Inhalte.
          </p>
        </div>
      </section>
      ...
      <section className="px-4 py-24 sm:py-32 lg:px-8 mx-auto max-w-4xl border-b border-zinc-900/50">
        ...
        <p className="text-sm text-zinc-500 mb-12">
          Stand April 2026. Aktive Entwicklung. Kein Produktionsrelease.
        </p>
        ...
        <div className="space-y-3 mb-10 bg-zinc-900/20 border border-zinc-800/60 rounded p-6">
          ...
          <div className="flex items-center gap-3">
            <CheckCircle2 className="h-5 w-5 text-emerald-500" />
            <span className="text-sm text-zinc-300">Offline-faehige Mobile App (Prototyp)</span>
          </div>
          <div className="flex items-center gap-3">
            <CheckCircle2 className="h-5 w-5 text-emerald-500" />
      ...
      <section className="px-4 py-24 sm:py-32 lg:px-8 mx-auto max-w-4xl border-b border-zinc-900/50">
        <h2 className="text-2xl font-medium tracking-tight text-zinc-100 mb-12">Fuer wen und wie</h2>
        ...
        <div className="grid md:grid-cols-2 gap-8">
          <div className="flex flex-col h-full border border-zinc-800/60 bg-zinc-900/20 rounded p-6 sm:p-8">
            ...
            <ul className="space-y-4 mb-8 flex-1">
              <li className="flex gap-3 text-sm text-zinc-400">
                ...
                Aerztliche Leitung gibt eine Inhaltsaenderung frei.
              </li>
              <li className="flex gap-3 text-sm text-zinc-400">
                <span className="text-zinc-600 mt-0.5">•</span>
                System verteilt neuen Bundle-Stand an alle Geraete der Organisation.
              </li>
              <li className="flex gap-3 text-sm text-zinc-400">
                <span className="text-zinc-600 mt-0.5">•</span>
                Nutzer sieht beim naechsten App-Start: "Inhalt aktualisiert".
              </li>
            </ul>
            <NavLink
              to="/mitwirken"
          ...
          <div className="flex flex-col h-full border border-zinc-800/60 bg-zinc-900/20 rounded p-6 sm:p-8">
            ...
            <h3 className="text-lg font-medium text-zinc-100 mb-4">Nachschlagen</h3>
            <ul className="space-y-4 mb-8 flex-1">
              <li className="flex gap-3 text-sm text-zinc-400">
                <span className="text-zinc-600 mt-0.5">•</span>
                Nutzer sucht offline nach einem Thema.
              </li>
              <li className="flex gap-3 text-sm text-zinc-400">
                <span className="text-zinc-600 mt-0.5">•</span>
                Findet den freigegebenen Inhalt der eigenen Organisation.
              </li>
              <li className="flex gap-3 text-sm text-zinc-400">
                <span className="text-zinc-600 mt-0.5">•</span>
                Kein Netz noetig, kein zusaetzlicher Login nach der Einrichtung erforderlich.
              </li>
            </ul>
            <NavLink
              to="/mitwirken"
      ...
      <section className="px-4 py-24 sm:py-32 lg:px-8 mx-auto max-w-4xl border-b border-zinc-900/50">
        ...
        <p className="text-zinc-400 text-lg leading-relaxed mb-12">
          Praxisrueckmeldungen aus dem Rettungsdienst entscheiden ueber die naechsten
        ...
        <div className="border border-zinc-800/60 bg-zinc-900/20 rounded p-6 sm:p-10 flex flex-col md:flex-row items-center gap-8 justify-between">
          <div>
            ...
            <p className="text-sm text-zinc-500">
              Stand April 2026. Teilen Sie Ihre Erfahrungen mit aktuellen SOP-Systemen.
            </p>
          </div>
        ...
        <div className="grid sm:grid-cols-2 gap-x-8 gap-y-10">
          <div className="flex gap-4">
            ...
            <div>
              ...
              <p className="text-sm text-zinc-500 leading-relaxed">
                Das initiale Datenmodell und die Struktur der Inhalte orientieren sich an gaengigen
                2026er Richtlinien (z.B. angelehnt an DBRD-Muster) und dienen als technischer
                Startpunkt.
              </p>
            </div>
          </div>
          ...
          <div className="flex gap-4">
            ...
            <div>
              ...
              <p className="text-sm text-zinc-500 leading-relaxed">
                Transparenz ist Pflicht. Der Quellcode der Plattform ist auf GitHub einsehbar, um
                Architektur und Sicherheit unabhaengig verifizieren zu koennen.
              </p>
            </div>
          </div>
          ...
          <div className="flex gap-4">
            ...
            <div>
              ...
              <p className="text-sm text-zinc-500 leading-relaxed">
                Kein Produkt-Pitch, kein Abo-Modell, kein Vendor Lock-in. ResQBrain ist ein von der
                Community getriebenes Open-Source Konzept.
              </p>
            </div>
          </div>
          ...
          <div className="flex gap-4">
            ...
            <div>
              ...
              <p className="text-sm text-zinc-500 leading-relaxed">
                Das System speichert keine Patientendaten und trackt keine Nutzerdaten ohne
      ...
      <section className="px-4 py-24 sm:py-32 lg:px-8 mx-auto max-w-4xl">
        ...
        <div className="space-y-4">
          <FAQItem
            ...
            answer="Nein. Dies ist ein striktes Referenz-System. Es gibt keine KI-gestuetzten Empfehlungen. Es zeigt lediglich die formell freigegebenen SOPs an."
          />
          <FAQItem
            question="Funktioniert es ohne Internet?"
            answer="Ja, das ist das Kernversprechen. Nach der einmaligen initialen Synchronisation beim App-Start ist die Such- und Darstellungslogik offline verfuegbar."
          />
          <FAQItem
            question="Wer ist fuer die Inhalte verantwortlich?"
            answer="Ausschliesslich die jeweilige Traegerorganisation bzw. deren Aerztliche Leitung Rettungsdienst (AELRD). ResQBrain liefert nur die technische Huelle (den 'Ordner'), nicht das medizinische Protokoll."
          />
          <FAQItem
            question="Wie komme ich rein / kann ich testen?"
            answer={
              <>
                Wir suchen aktuell Organisationen fuer erste Validierungstests des Backends. Wenn
                Sie im Qualitaetsmanagement oder als AELRD taetig sind:{" "}
                <NavLink to="/mitwirken" className="text-emerald-500 hover:text-emerald-400 font-medium">
                  Nutzen Sie den Mitwirken-Bereich
                </NavLink>
                .
              </>
            }
    ...
    <div className="border border-zinc-800/60 rounded bg-zinc-900/10 overflow-hidden">
      ...
      {isOpen && (
        <div className="p-6 pt-0 mt-2">
          <p className="text-sm text-zinc-400 leading-relaxed max-w-3xl">{answer}</p>
        </div>
      )}
    </div>
  );
