...
export function isOrganizationScopedAccess(subject, context) {
    return subject.organizationId === context.organizationId;
}
export function hasRoleInOrganization(subject, role, context) {
    return subject.roles.some((assignment) => assignment.organizationId === context.organizationId &&
        assignment.role === role);
}
export function hasPermissionInOrganization(subject, permission, context) {
 ...
 */
export function evaluateAccessPolicy(subject, context, permission, requiredRole) {
 ...
 */
export function assertAccessPolicy(subject, context, permission, requiredRole) {
