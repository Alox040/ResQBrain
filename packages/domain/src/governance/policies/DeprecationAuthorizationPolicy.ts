...
import type { DeprecationContext, PolicyContext } from './PolicyContext';

export function evaluateDeprecation(context: DeprecationContext): PolicyDecision {
...
function buildAccessContext(
  ...
  return {
    ...
    capability:
      context.entityType === EntityTypeValue.ContentPackage
        ? 'package.deprecate'
        : 'content.deprecate',
    entityId: context.entityId,
    entityType: context.entityType,
