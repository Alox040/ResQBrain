...
import type { ApplicabilityScope, OrganizationContext } from '../common/scope';

export type TenantScope = ApplicabilityScope;

export interface ResolvedScope extends OrganizationContext {
  readonly regionId: RegionId | null;
  readonly countyId: CountyId | null;
  readonly stationId: StationId | null;
}

export type ScopeContext = OrganizationContext;
